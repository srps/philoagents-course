...
export class Preloader extends Scene
{
    ...
    preload ()
    {
        ...
        this.load.atlas("sergio", "characters/sergio/atlas.png", "characters/sergio/atlas.json");
        this.load.atlas("mines", "characters/mines/atlas.png", "characters/mines/atlas.json");
    }
